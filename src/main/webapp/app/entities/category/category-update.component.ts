...
export class CategoryUpdateComponent implements OnInit {
    ...
    save() {
        this.isSaving = true;
        this.category.createdDate = moment(this.createdDate, DATE_TIME_FORMAT);
        this.category.updatedDate = moment(this.updatedDate, DATE_TIME_FORMAT);
    ...
    set category(category: ICategory) {
        ...
        this.createdDate = moment(category.createdDate).format(DATE_TIME_FORMAT);
        this.updatedDate = moment(category.updatedDate).format(DATE_TIME_FORMAT);
    }
}
